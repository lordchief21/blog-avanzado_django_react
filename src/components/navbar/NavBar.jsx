    ...
    <header className="opacity-70">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          ...
          <a href="#" className="flex items-center gap-x-1 text-sm font-semibold leading-6">
            About me
          </a>
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y">
              <div className="space-y-2 py-6">
                ...
                <a href='#' className="flex w-full items-center justify-between rounded-lg py-2 pl-3 pr-3.5 text-base font-semibold leading-7 hover:bg-gray-50">
                        Product
                </a>
